...
agent_id: agent-global-gates
model: gpt-5.4-mini
reasoning_effort: medium
owner: 09-global-minimum-gates
step_source: src/project/contract/manifest.js + src/kernel/store/createStore.js + src/kernel/store/applyPatches.js
goal: Validate mandatory SoT and patch pipeline gates
