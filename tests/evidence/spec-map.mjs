...
export const REGRESSION_TEST_STATUS = Object.freeze({
  ...
  "tests/test-whole-repo-dispatch-truth.mjs": Object.freeze({
    status: "verified",
    budgetMs: 120_000,
  ...
  "tests/test-legacy-zone-compat-routing.mjs": Object.freeze({
    status: "verified",
    budgetMs: 90_000,
  ...
  "tests/test-whole-repo-dispatch-truth.mjs": Object.freeze({
    status: "verified",
    budgetMs: 120_000,
    purpose: "prove dataflow dispatchSources stays fully aligned with real dispatch calls across the whole src tree",
    counterProbe: "missing or stale dispatch source declarations are detected as contract drift",
  }),
});
