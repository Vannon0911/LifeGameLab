...
Spezifische Guards + messbare Done-Kriterien: Guard: Blocks unsafe mutations and invariant breaks. Done: `PROTOCOL_REPORT.md` exists and states protocol findings.
