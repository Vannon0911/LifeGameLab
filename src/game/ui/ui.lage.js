...
import { evaluateFoundationEligibility } from "../runtime/foundationEligibility.js";
import {
  countZoneRoleTiles,
  formatPatternBonusSummary,
  getPatternClassCount,
  getZoneMetaCount,
  summarizeFog,
} from "../viewmodel/lageStats.js";
import {
  getActionState,
  getBottleneckState,
  getGoalState,
...
export function renderLagePanel({
  ...
  zoneSummaryCard.append(
    ...
    mkMetric("Pattern-Boni", formatPatternBonusSummary(patternBonuses, fmtSign)),
  );
