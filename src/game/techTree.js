...
export const TECH_TREE = [
  ...
  { id: "toxin_resist", label: "Toxinfilter", desc: "Entlastet fragile Linien in giftigen Feldern.", stage: 1, lane: "survival", requires: [], commandReq: 0.00 },
  {
    ...
    commandReq: 0.08,
    runRequirements: { requiresInfra: true },
  },
  {
  ...
  },
  {
    ...
    requires: ["nutrient_harvest"],
    commandReq: 0.10,
    runRequirements: { minExpansionCount: 1 },
  },
  {
    id: "defensive_shell",
    label: "Schutzhülle",
    ...
    commandReq: 0.18,
    runRequirements: { requiresInfra: true, positivePatternBonuses: ["defense", "stability"] },
  },
  {
    id: "predator_raid",
    label: "Raid-Reflex",
    ...
    requires: ["cooperative_network"],
    commandReq: 0.20,
    runRequirements: { requiresInfra: true, minExpansionCount: 1 },
  },
  {
    id: "nomadic_adapt",
    label: "Nomadenpfad",
  ...
  },
  {
    ...
    commandReq: 0.34,
    runRequirements: { requiresInfra: true, minExpansionCount: 2 },
  },
  {
    id: "symbiotic_bloom",
  ...
  },
  {
    ...
    commandReq: 0.34,
    runRequirements: { requiresInfra: true, minPatternClasses: 3, positivePatternBonuses: ["dna", "stability"] },
  },
];
