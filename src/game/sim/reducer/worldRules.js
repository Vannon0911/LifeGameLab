...
export function expandWorldPreserve(world, step = 1) {
  ...
  next.zoneRole = copy1(world.zoneRole || new Uint8Array(oldN), Uint8Array);
  next.zoneId = copy1(world.zoneId || new Int32Array(oldN), Int32Array);
  next.zoneMeta = { ...(world.zoneMeta || {}) };
  ...
  next.visibility = copy1(world.visibility || new Uint8Array(oldN), Uint8Array);
  next.explored = copy1(world.explored || new Uint8Array(oldN), Uint8Array);
