...
- `rename`: `TOGGLE_DNA_ZONE_WORKER -> PLACE_BUILDING`, `BUILD_INFRA_PATH -> PLACE_LINE_SEGMENT`, `PLACE_SPLIT_CLUSTER -> PLACE_BUILDING`, `HARVEST_WORKER -> QUEUE_WORKER`, `SET_ZONE -> PLACE_BUILDING`
